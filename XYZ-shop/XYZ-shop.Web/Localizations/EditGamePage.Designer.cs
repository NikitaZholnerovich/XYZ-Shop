namespace XYZ_shop.Web.Localizations
{
    ...
    public class EditGamePage
    {
        private static readonly ResourceManager ResourceManager =
            new ResourceManager("XYZ_shop.Web.Localizations.EditGamePage", typeof(EditGamePage).Assembly);

        public static string Title => ResourceManager.GetString(nameof(Title), CultureInfo.CurrentUICulture)!;
        public static string Back_To_Game => ResourceManager.GetString(nameof(Back_To_Game), CultureInfo.CurrentUICulture)!;
